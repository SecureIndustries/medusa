...
enum {
        ...
        MEDUSA_SUBJECT_TYPE_WEBSOCKETSERVER             = 11,
        MEDUSA_SUBJECT_TYPE_WEBSOCKETSERVER_CLIENT      = 12,
        MEDUSA_SUBJECT_TYPE_HTTPSERVER                  = 13,
        MEDUSA_SUBJECT_TYPE_HTTPSERVER_CLIENT           = 14

...
enum {
        ...
        MEDUSA_SUBJECT_TYPE_WEBSOCKETSERVER             = 12,
        MEDUSA_SUBJECT_TYPE_WEBSOCKETSERVER_CLIENT      = 13,
        MEDUSA_SUBJECT_TYPE_HTTPSERVER                  = 14,
        MEDUSA_SUBJECT_TYPE_HTTPSERVER_CLIENT           = 15

...
enum {
        ...
        MEDUSA_SUBJECT_TYPE_HTTPREQUEST                 = 7,
        MEDUSA_SUBJECT_TYPE_DNSREQUEST                  = 8,
        MEDUSA_SUBJECT_TYPE_EXEC                        = 9,
        MEDUSA_SUBJECT_TYPE_WEBSOCKETSERVER             = 10,
        MEDUSA_SUBJECT_TYPE_WEBSOCKETSERVER_CLIENT      = 11,
        MEDUSA_SUBJECT_TYPE_HTTPSERVER                  = 12,
        MEDUSA_SUBJECT_TYPE_HTTPSERVER_CLIENT           = 13

...
__attribute__ ((visibility ("default"))) int medusa_tcpsocket_init_unlocked (struct medusa_tcpsocket *tcpsocket, struct medusa_monitor *monitor, int (*onevent) (struct medusa_tcpsocket *tcpsocket, unsigned int events, void *context, void *param), void *context)
{
        int rc;
...
__attribute__ ((visibility ("default"))) int medusa_tcpsocket_init (struct medusa_tcpsocket *tcpsocket, struct medusa_monitor *monitor, int (*onevent) (struct medusa_tcpsocket *tcpsocket, unsigned int events, void *context, void *param), void *context)
{
        int rc;
        if (MEDUSA_IS_ERR_OR_NULL(tcpsocket)) {
                return -EINVAL;
...
__attribute__ ((visibility ("default"))) int medusa_tcpsocket_init_with_options_unlocked (struct medusa_tcpsocket *tcpsocket, const struct medusa_tcpsocket_init_options *options)
{
        ...
        rc = medusa_tcpsocket_set_interface_unlocked(tcpsocket, options->interface);
        if (rc < 0) {
                return rc;
        }
...
__attribute__ ((visibility ("default"))) struct medusa_tcpsocket * medusa_tcpsocket_create_unlocked (struct medusa_monitor *monitor, int (*onevent) (struct medusa_tcpsocket *tcpsocket, unsigned int events, void *context, void *param), void *context)
{
        int rc;
        struct medusa_tcpsocket_init_options options;
        rc = medusa_tcpsocket_init_options_default(&options);
...
__attribute__ ((visibility ("default"))) struct medusa_tcpsocket * medusa_tcpsocket_create (struct medusa_monitor *monitor, int (*onevent) (struct medusa_tcpsocket *tcpsocket, unsigned int events, void *context, void *param), void *context)
{
...
__attribute__ ((visibility ("default"))) int medusa_tcpsocket_set_interface_unlocked (struct medusa_tcpsocket *tcpsocket, const char *interface)
{
        if (MEDUSA_IS_ERR_OR_NULL(tcpsocket)) {
                return -EINVAL;
        }
        ...
        if (interface) {
                tcpsocket->interface = strdup(interface);
                if (tcpsocket->interface == NULL) {
                        return -ENOMEM;
                }
        }
...
__attribute__ ((visibility ("default"))) int medusa_tcpsocket_set_interface (struct medusa_tcpsocket *tcpsocket, const char *interface)
{
        int rc;
        if (MEDUSA_IS_ERR_OR_NULL(tcpsocket)) {
                return -EINVAL;
        ...
        medusa_monitor_lock(tcpsocket->subject.monitor);
        rc = medusa_tcpsocket_set_interface_unlocked(tcpsocket, interface);
        medusa_monitor_unlock(tcpsocket->subject.monitor);
        return rc;
}

__attribute__ ((visibility ("default"))) const char * medusa_tcpsocket_get_interface_unlocked (const struct medusa_tcpsocket *tcpsocket)
{
        if (MEDUSA_IS_ERR_OR_NULL(tcpsocket)) {
                return NULL;
        }
        return tcpsocket->interface;
}

__attribute__ ((visibility ("default"))) const char * medusa_tcpsocket_get_interface (const struct medusa_tcpsocket *tcpsocket)
{
        const char *rc;
        if (MEDUSA_IS_ERR_OR_NULL(tcpsocket)) {
                return NULL;
        ...
        medusa_monitor_lock(tcpsocket->subject.monitor);
        rc = medusa_tcpsocket_get_interface_unlocked(tcpsocket);
        medusa_monitor_unlock(tcpsocket->subject.monitor);
        return rc;
}
...
__attribute__ ((visibility ("default"))) int medusa_tcpsocket_bind_with_options_unlocked (struct medusa_tcpsocket *tcpsocket, const struct medusa_tcpsocket_bind_options *options)
{
        int rc;
        int fd;
        int ret;
...
__attribute__ ((visibility ("default"))) int medusa_tcpsocket_bind_with_options (struct medusa_tcpsocket *tcpsocket, const struct medusa_tcpsocket_bind_options *options)
{
        int rc;
        if (MEDUSA_IS_ERR_OR_NULL(tcpsocket)) {
                return -EINVAL;
        ...
        medusa_monitor_lock(tcpsocket->subject.monitor);
        rc = medusa_tcpsocket_bind_with_options_unlocked(tcpsocket, options);
        medusa_monitor_unlock(tcpsocket->subject.monitor);
        return rc;
}
...
__attribute__ ((visibility ("default"))) int medusa_tcpsocket_bind_unlocked (struct medusa_tcpsocket *tcpsocket, unsigned int protocol, const char *address, unsigned short port)
{
        ...
        options.port     = port;
        return medusa_tcpsocket_bind_with_options_unlocked(tcpsocket, &options);
}
...
__attribute__ ((visibility ("default"))) int medusa_tcpsocket_connect_with_options_unlocked (struct medusa_tcpsocket *tcpsocket, const struct medusa_tcpsocket_connect_options *options)
{
        int rc;
        int fd;
        int ret;
...
__attribute__ ((visibility ("default"))) int medusa_tcpsocket_connect_with_options (struct medusa_tcpsocket *tcpsocket, const struct medusa_tcpsocket_connect_options *options)
{
        int rc;
        if (MEDUSA_IS_ERR_OR_NULL(tcpsocket)) {
                return -EINVAL;
        ...
        medusa_monitor_lock(tcpsocket->subject.monitor);
        rc = medusa_tcpsocket_connect_with_options_unlocked(tcpsocket, options);
        medusa_monitor_unlock(tcpsocket->subject.monitor);
        return rc;
}
...
__attribute__ ((visibility ("default"))) int medusa_tcpsocket_connect_unlocked (struct medusa_tcpsocket *tcpsocket, unsigned int protocol, const char *address, unsigned short port)
{
        ...
        options.address  = address;
        options.port     = port;
        return medusa_tcpsocket_connect_with_options_unlocked(tcpsocket, &options);
}
...
__attribute__ ((visibility ("default"))) int medusa_tcpsocket_accept_init_unlocked (struct medusa_tcpsocket *accepted, struct medusa_tcpsocket *tcpsocket, int (*onevent) (struct medusa_tcpsocket *tcpsocket, unsigned int events, void *context, void *param), void *context)
{
        int rc;
...
__attribute__ ((visibility ("default"))) int medusa_tcpsocket_accept_init (struct medusa_tcpsocket *accepted, struct medusa_tcpsocket *tcpsocket, int (*onevent) (struct medusa_tcpsocket *tcpsocket, unsigned int events, void *context, void *param), void *context)
{
        int rc;
        struct medusa_monitor *monitor;
        monitor = medusa_tcpsocket_get_monitor(tcpsocket);
...
__attribute__ ((visibility ("default"))) int medusa_tcpsocket_accept_init_with_options_unlocked (struct medusa_tcpsocket *accepted, struct medusa_tcpsocket *tcpsocket, const struct medusa_tcpsocket_accept_options *options)
{
        ...
        accepted_options.interface   = options->interface;

...
enum {
        ...
        MEDUSA_WEBSOCKETSERVER_CLIENT_EVENT_FRAME_RECEIVED      = (1 << 6),
        MEDUSA_WEBSOCKETSERVER_CLIENT_EVENT_DESTROY             = (1 << 7)
...
#define MEDUSA_WEBSOCKETSERVER_CLIENT_EVENT_FRAME_RECEIVED      MEDUSA_WEBSOCKETSERVER_CLIENT_EVENT_FRAME_RECEIVED
...
enum {
        ...
        MEDUSA_WEBSOCKETSERVER_CLIENT_FRAME_TYPE_POMG           = 3,
...
#define MEDUSA_WEBSOCKETSERVER_CLIENT_FRAME_TYPE_POMG           MEDUSA_WEBSOCKETSERVER_CLIENT_FRAME_TYPE_POMG
...
struct medusa_websocketserver_client_frame_received {
        unsigned int final;
        unsigned int type;
        unsigned int length;
        const void *payload;

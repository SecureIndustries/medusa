...
enum {
        ...
        MEDUSA_TCPSOCKET_EVENT_ATTACHED         = 0x00000800,
        MEDUSA_TCPSOCKET_EVENT_IN               = 0x00001000,
        MEDUSA_TCPSOCKET_EVENT_PRI              = 0x00002000,
        MEDUSA_TCPSOCKET_EVENT_OUT              = 0x00004000,
...
#define MEDUSA_TCPSOCKET_EVENT_ATTACHED         MEDUSA_TCPSOCKET_EVENT_ATTACHED
};
...
enum {
        ...
        MEDUSA_TCPSOCKET_STATE_ATTACHED         = 10
...
#define MEDUSA_TCPSOCKET_STATE_ATTACHED         MEDUSA_TCPSOCKET_STATE_ATTACHED
};

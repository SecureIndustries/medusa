...
enum {
        ...
        MEDUSA_TCPSOCKET_EVENT_RESOLVING        = 0x00000008,
        MEDUSA_TCPSOCKET_EVENT_RESOLVE_TIMEOUT  = 0x00000010,
        MEDUSA_TCPSOCKET_EVENT_RESOLVED         = 0x00000020,
        MEDUSA_TCPSOCKET_EVENT_CONNECTING       = 0x00000040,
        MEDUSA_TCPSOCKET_EVENT_CONNECT_TIMEOUT  = 0x00000080,
        MEDUSA_TCPSOCKET_EVENT_CONNECTED        = 0x00000100,
        MEDUSA_TCPSOCKET_EVENT_WRITE_TIMEOUT    = 0x00000200,
        MEDUSA_TCPSOCKET_EVENT_WRITTEN          = 0x00000400,
        MEDUSA_TCPSOCKET_EVENT_READ             = 0x00000800,
        MEDUSA_TCPSOCKET_EVENT_READ_TIMEOUT     = 0x00001000,

...
int medusa_condition_init_unlocked (struct medusa_condition *condition, struct medusa_monitor *monitor, int (*onevent) (struct medusa_condition *condition, unsigned int events, void *context, ...), void *context);
...
struct medusa_condition * medusa_condition_create_unlocked (struct medusa_monitor *monitor, int (*onevent) (struct medusa_condition *condition, unsigned int events, void *context, ...), void *context);
...
int medusa_condition_onevent_unlocked (struct medusa_condition *condition, unsigned int events);

...
int medusa_timer_set_initial_timeval (struct medusa_timer *timer, const struct timeval *timeval);
int medusa_timer_set_initial_timespec (struct medusa_timer *timer, const struct timespec *timespec);
...
int medusa_timer_set_interval_timeval (struct medusa_timer *timer, const struct timeval *timeval);
int medusa_timer_set_interval_timespec (struct medusa_timer *timer, const struct timespec *timespec);
